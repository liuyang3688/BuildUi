...
(function ($) {
    ...
    function setSize(target, param) {
        ...
        if (opts.height == "auto") {
            input.css({margin: "", paddingTop: "", paddingBottom: "", height: "", lineHeight: ""});
        }
        ...
        icons.css({width: opts.iconWidth + "px", height: inputHeight + "px"});
        input.css({
        ...
        if (opts.multiline) {
            input.css({paddingTop: (target.style.paddingTop || ""), paddingBottom: (target.style.paddingBottom || "")});
            input._outerHeight(inputHeight);
        } else {
            input.css({paddingTop: 0, paddingBottom: 0, height: inputHeight + "px", lineHeight: inputHeight + "px"});
        }
    ...
    $.fn.textbox.methods = {
        options: function (jq) {
            ...
            return jq.each(function () {
                ...
                $.data(this, "textbox", {options: opts, textbox: span, label: (label.length ? label : undefined)});
        ...
        }, readonly: function (jq, width) {
            return jq.each(function () {
                setReadonly(this, width);
                bindEvents(this);
            });
        }, isValid: function (jq) {
