        ...
        if (typeof options == "string") {
            ...
            return this.each(function () {
                ...
                if (state) {
                    ...
                    state = $.data(this, "navpanel", {options: $.extend({}, $.fn.navpanel.defaults, $.fn.navpanel.parseOptions(this), options)});
                }
...
(function ($) {
    ...
    $.mobile = {
        ...
        }, panels: [], init: function (container) {
            $.mobile.panels = [];
    ...
    $.map(["validatebox", "textbox", "passwordbox", "filebox", "searchbox", "combo", "combobox", "combogrid", "combotree", "combotreegrid", "datebox", "datetimebox", "numberbox", "spinner", "numberspinner", "timespinner", "datetimespinner"], function (plugin) {
        if ($.fn[plugin]) {
            $.extend($.fn[plugin].defaults, {iconWidth: 28, tipPosition: "bottom"});
        }
    });
    $.map(["spinner", "numberspinner", "timespinner", "datetimespinner"], function (plugin) {
        if ($.fn[plugin]) {
            $.extend($.fn[plugin].defaults, {iconWidth: 56, spinAlign: "horizontal"});
        }
    });
    if ($.fn.menu) {
