...
(function ($) {
    ...
    function buildCombo(target) {
        ...
        for (var e in opts.panelEvents) {
            state.panel.bind(e + ".combo", {target: target}, opts.panelEvents[e]);
        }
    };
    ...
    function showPanel(target) {
        ...
        (function () {
            if (palOpts.comboTarget == target && panel.is(":visible")) {
                panel.panel("move", {left: getLeft(), top: getTop()});
    ...
    $.fn.combo.defaults = $.extend({}, $.fn.textbox.defaults, {
        inputEvents: {click: inputClickHandler, keydown: inputEventHandler, paste: inputEventHandler, drop: inputEventHandler, blur: clearTimer},
        panelEvents: {
