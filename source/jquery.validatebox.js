...
(function ($) {
    ...
    $.fn.validatebox = function (options, param) {
        ...
        return this.each(function () {
            ...
            if (state) {
                ...
                init(this);
                state = $.data(this, "validatebox", {options: $.extend({}, $.fn.validatebox.defaults, $.fn.validatebox.parseOptions(this), options)});
            }
    ...
    $.fn.validatebox.defaults = {
        ...
        events: {
            focus: focusEventHandler, blur: blurEventHandler, mouseenter: mouseenterEventHandler, mouseleave: mouseleaveEventHandler, click: function (e) {
                var t = $(e.data.target);
