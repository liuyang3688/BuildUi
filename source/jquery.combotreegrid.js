...
(function ($) {
    ...
    function doQuery(target, q) {
        ...
        if (opts.mode == "remote") {
            ...
            if (q) {
                ...
                setValuesNotReversed(vv);
                state.remainText = false;
            }
        }

        function setValuesNotReversed(vv) {
            if (!opts.reversed) {
    ...
    $.fn.combotreegrid = function (options, param) {
        ...
        return this.each(function () {
            ...
            if (state) {
                ...
                state = $.data(this, "combotreegrid", {options: $.extend({}, $.fn.combotreegrid.defaults, $.fn.combotreegrid.parseOptions(this), options)});
            }
            create(this);
        });
    };
    ...
    $.fn.combotreegrid.parseOptions = function (target) {
        var t = $(target);
        return $.extend({}, $.fn.combo.parseOptions(target), $.fn.treegrid.parseOptions(target), $.parser.parseOptions(target, ["mode", {limitToGrid: "boolean"}]));
    };
