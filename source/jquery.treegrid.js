...
(function ($) {
    ...
    function insert(target, param) {
        ...
        append(target, {parent: (pnode ? pnode[opts.idField] : null), data: [param.data]});
    ...
    var defaultView = $.extend({}, $.fn.datagrid.defaults.view, {
        render: function (target, container, frozen) {
            ...
            function getTreeData(frozen, depth, children) {
                var pnode = $(target).treegrid("getParent", children[0][_e9.idField]);
