...
(function ($) {
    function buildBox(target) {
        ...
        $(target).addClass("passwordbox-f").textbox($.extend({}, opts, {icons: icons}));
        setValue(target);
    };
    ...
    $.fn.passwordbox = function (options, param) {
        ...
        return this.each(function () {
            ...
            if (state) {
                ...
                state = $.data(this, "passwordbox", {options: $.extend({}, $.fn.passwordbox.defaults, $.fn.passwordbox.parseOptions(this), options)});
            }
            buildBox(this);
        });
    };
    ...
    $.fn.passwordbox.defaults = $.extend({}, $.fn.textbox.defaults, {
        ...
        revealed: false,
        showEye: true,
        inputEvents: {focus: focusHandler, blur: blurHandler},
        val: function (target) {
