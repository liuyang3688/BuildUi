...
(function ($) {
    ...
    function setSize(target, param) {
        ...
        var width1 = panel.outerWidth();
        var height1 = panel.outerHeight();
        panel._size(opts);
        var width2 = panel.outerWidth();
        var height2 = panel.outerHeight();
        if (opts.hasResized && (width1 == width2 && height1 == height2)) {
            return;
        }
        ...
        panel.css({height: (isHorizontal ? undefined : ""), minHeight: "", maxHeight: "", left: opts.left, top: opts.top});
