...
(function ($) {
        ...
        function getSelectedItem() {
            if (state.menu) {
                ...
                state.menu.children("div.menu-item").each(function () {
                    var itemOpts = $.extend({}, $.parser.parseOptions(this), {selected: ($(this).attr("selected") ? true : undefined)});
    ...
    $.fn.searchbox.parseOptions = function (target) {
        var t = $(target);
        return $.extend({}, $.fn.textbox.parseOptions(target), $.parser.parseOptions(target, ["menu"]), {searcher: (t.attr("searcher") ? eval(t.attr("searcher")) : undefined)});
    };
    $.fn.searchbox.defaults = $.extend({}, $.fn.textbox.defaults, {
        ...
        }), buttonAlign: "left", menu: null, searcher: function (value, name) {
        }
    });
})(jQuery);
