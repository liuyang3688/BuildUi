...
(function ($) {
    ...
    function enableDnd(target) {
        ...
        function append(source, dest) {
            ...
            function doAppend() {
                ...
                $(target).tree("append", {parent: dest, data: [node]});
    ...
    function setCheckedFlag(target, nodedata, flag) {
        var opts = $.data(target, "tree").options;
        if (!nodedata.checkState || flag == undefined) {
            return;
        }
        if (nodedata.hidden && !opts.deepCheck) {
            return;
        }
    ...
    function adjustCheck(target, nodeEl) {
        ...
        if (opts.view.hasCheckbox(target, nodedata)) {
            ...
            if (nodedata.checkState == "checked") {
                ...
                if (nodedata.checkState == "unchecked") {
    ...
    function insertNode(target, param) {
        ...
        appendNodes(target, {parent: (pnode ? pnode.target : null), data: data});
    ...
    function findNode(target, options) {
        if ($.isFunction(options)) {
            var fn = options;
        } else {
            var options = typeof options == "object" ? options : {id: options};
    ...
    $.fn.tree = function (options, param) {
        ...
        return this.each(function () {
            ...
            if (state) {
                ...
                $.data(this, "tree", {options: opts, tree: wrapTree(this), data: [], tmpIds: []});
    ...
    $.fn.tree.methods = {
        options: function (jq) {
            ...
            return jq.each(function () {
                updateNode(this, $.extend({}, param, {checkState: param.checked ? "checked" : (param.checked === false ? "unchecked" : undefined)}));
            });
