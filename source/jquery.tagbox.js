...
(function ($) {
    function create(target) {
        ...
        $(target).addClass("tagbox-f").combobox($.extend({}, opts, {
            ...
            onChange: function (newValue, oldValue) {
                ...
                var width = tb.outerWidth();
                tb.css({height: "", paddingLeft: input.css("marginLeft"), paddingRight: input.css("marginRight")});
                input.css("margin", 0);
                tb._outerWidth(width);
    ...
    function resizeLabel(target, label) {
        ...
        if (labels.length) {
            ...
            labels.css({height: height + "px", lineHeight: height + "px"});
    ...
    $.fn.tagbox = function (options, param) {
        ...
        return this.each(function () {
            ...
            if (state) {
                ...
                $.data(this, "tagbox", {options: $.extend({}, $.fn.tagbox.defaults, $.fn.tagbox.parseOptions(this), options)});
            }
            create(this);
            bindEvents(this);
        });
